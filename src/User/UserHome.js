      ...
      <div className='wrapper'>
        ...
        <header className="header">
                        ...
                        <div className="row">
                            <div className="col-md-8 col-sm-8 col-xs-12">
                                <div className="contact">
                                    <p><span className="phone"><a href="/">Phone: +91 9344216042 {mobile}</a></span><span className="email"><a href="/">Email: mohanmahi9677@gmail.com {email}</a></span></p>
                                </div>
                            </div>
            ...
            <section className="our_activity">
                <h2>OUR ACTIVITY</h2>
                <p>connect clients to services, accept donations from donors, find volunteers, share news, inspire people who are interested and much more. It can be a lot! </p>
                <div className="container">
                    <div className="row">
                        <div className="col-md-4 col-xs-12">
                            <div className="single-Promo">
                                ...
                                <p> Organizing or participating in fundraising events is a popular way to support charities. This could involve running marathons, hosting charity dinners, organizing auctions, or setting up crowdfunding campaigns. </p>
                            </div>
                        </div>
                        <div className="col-md-4 col-xs-12">
                            <div className="single-Promo">
                                ...
                                <p>Giving your time and skills to a charitable organization can be extremely valuable. Volunteering opportunities can range from working at food banks, shelters, hospitals, schools, or participating in community clean-up events. </p>
                            </div>
                        </div>
                        <div className="col-md-4 col-xs-12">
                            <div className="single-Promo">
                                ...
                                <p> If you have specific skills or expertise, you can offer your services to organizations in need. This could include teaching, mentoring, providing legal advice, or offering professional services. </p>
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div className="col-md-12">
                            <div className="carosal_bottom_single owl-carousel owl-theme">
                                <div className="item">
                                    ...
                                    <h4>Mohan</h4>
                                    <p>web devloper</p>
                                    <h6>Designer of this website</h6>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="row">
                        ...
                        <div className="col-md-4">
                            <div className="single_news">
                                ...
                                <div className="texts">
                                    <p className="date"><a href="/">30 May, 2023</a></p>
                                    <h3>fund collect for children</h3>
                                    <p className="test"> </p>
                                    <h3><a href="/">READ MORE</a></h3>
                                </div>
                            </div>
            ...
            <footer className="footer">
                            ...
                            <div className="row">
                                <div className="col-md-4 col-sm-5">
                                    <div className="footer-text one">
                                        <h3>RECENT POST</h3>
                                        <ul>
                                            <li><a href="/"><i className="material-icons">keyboard_arrow_right</i> donation</a></li>
                                            <li><a href="/"><i className="material-icons">keyboard_arrow_right</i> free food  </a></li>
                                            <li><a href="/"><i className="material-icons">keyboard_arrow_right</i> Programs</a></li>
                                            <li><a href="/"><i className="material-icons">keyboard_arrow_right</i> Education</a></li>
                                            <li><a href="/"><i className="material-icons">keyboard_arrow_right</i> other</a></li>
                                        </ul>
                                    </div>
                                </div>
                                ...
                                <div className="col-md-4 col-sm-4">
                                    <div className="footer-text one">
                                        <h3>CONTACT US</h3>
                                        <ul>
                                            <li><a href="/"><i className="material-icons">location_on</i>1 Street,  FL 2147, coimbatore</a></li>
                                            <li><a href="/"><i className="material-icons">email</i>mohanmahi9677@gmail.com</a></li>
                                            <li><a href="/"><i className="material-icons">call</i>9344216042</a></li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
                ...
                {/* <div className="footer_bottom">
                    <p>Mohan Copyright @ 2023 <a href="/">DartThemes</a> | All Rights Reserved </p>
                </div> */}
            </footer>
            {/* Footer End */}
